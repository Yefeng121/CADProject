...
#import "CADTeamMembersView.h"
#import "CADMembersModel.h"
@interface CADTeamMembersView ()<UITableViewDelegate,UITableViewDataSource>
@property (nonatomic, strong) NSMutableArray *dataArray;
@property (nonatomic, strong) UITableView *tableView;

@end

@implementation CADTeamMembersView
...
@implementation CADTeamMembersCell
...
+ (CADTeamMembersCell *)createTableViewCellWith:(UITableView *)tableView withModel:(id)model{
	...
	CADTeamMembersCell *cell = [tableView dequeueReusableCellWithIdentifier:cellID];
	
	if (!cell) {
		cell = [[CADTeamMembersCell alloc] initWithStyle:UITableViewCellStyleSubtitle reuseIdentifier:cellID];
	}
