...
#import "CADFileManagerTool.h"

@implementation CADFileManagerTool
	///获取Document路径
+(NSString *)getDocumentPathCADFile{
	
	NSString *path = [[CADFileManagerTool getDocumentPath] stringByAppendingString:@"/CADFile"];
	return path;
}
	///获取Document路径
